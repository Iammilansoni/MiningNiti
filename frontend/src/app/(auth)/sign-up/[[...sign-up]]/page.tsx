  ...
  return (
    <main className="grid min-h-screen bg-[#05030A] lg:grid-cols-[1fr_500px]">
      ...
      <section className="relative hidden lg:flex lg:flex-col overflow-hidden">
        ...
        {/* Layered overlays */}
        <div className="absolute inset-0 bg-gradient-to-br from-[#05030A]/90 via-[#0d0520]/60 to-[#05030A]/30" />
        ...
        <div className="relative z-10 flex flex-col h-full p-10">
          ...
          <div className="mt-auto">
            ...
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-[#947AFC]/30 bg-[#947AFC]/10 backdrop-blur-sm px-3.5 py-1.5 text-sm text-white/70">
              <Building2 className="size-4 text-[#947AFC]" />
            ...
            <div className="flex gap-3">
              ...
              <div className="flex items-center gap-2 bg-white/[0.06] backdrop-blur-sm border border-white/10 rounded-xl px-4 py-2.5">
                <Users className="size-3.5 text-[#947AFC]" />
                <div>
      ...
      <section className="flex items-center justify-center px-6 py-10 bg-[#05030A] border-l border-white/[0.06]">
        <div className="w-full max-w-[400px]">
          ...
          <p className="mt-6 text-center text-[13px] text-white/40">
            ...
            <Link href="/sign-in" className="text-[#947AFC] hover:text-[#c4a0f0] font-medium transition-colors">
              Sign in
            </Link>
          </p>
        </div>
