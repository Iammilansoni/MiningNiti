  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#0A0A0B]">
      ...
      <main className="flex-1 pt-24 flex">
        ...
        <aside className="w-[280px] hidden lg:block shrink-0 border-r border-white/8 p-8 sticky top-0 h-screen overflow-y-auto">
          <div className="mb-8">
            <h4 className="text-xs font-mono text-white/40 uppercase tracking-widest mb-3">Getting Started</h4>
            <ul className="space-y-2.5 text-[14px]">
              <li><a href="#" className="text-purple-400 font-medium">Authentication</a></li>
        ...
        <div className="flex-1 max-w-[900px] p-8 lg:p-16">
          <p className="text-[11px] font-mono tracking-[0.2em] uppercase text-purple-400 mb-4">REST API</p>
          ...
          <div className="grid gap-16">
            ...
            <div className="grid xl:grid-cols-[1fr_1.2fr] gap-8 items-start">
              <div className="prose prose-invert prose-p:text-white/60 prose-headings:text-white prose-a:text-purple-400">
                <div className="flex items-center gap-3 mb-4">
                  <span className="px-2 py-1 rounded bg-purple-400/10 text-purple-400 text-xs font-mono font-bold">POST</span>
                ...
                <h4 className="text-sm border-b border-white/8 pb-2 mb-4">Parameters</h4>
                <div className="text-sm text-white/60 mb-2"><code className="text-white bg-white/4 px-1.5 py-0.5 rounded">file</code> (binary) - Required</div>
                <div className="text-sm text-white/60 mb-2"><code className="text-white bg-white/4 px-1.5 py-0.5 rounded">metadata</code> (json) - Optional site/zone tags</div>
              </div>

              <div className="bg-white/2 border border-white/8 rounded-xl overflow-hidden shadow-2xl">
                <div className="flex items-center gap-2 px-4 py-3 border-b border-white/4 bg-[#0A0A0B]/40">
            ...
            <div className="grid xl:grid-cols-[1fr_1.2fr] gap-8 items-start">
              <div className="prose prose-invert prose-p:text-white/60 prose-headings:text-white prose-a:text-purple-400">
                ...
                <h4 className="text-sm border-b border-white/8 pb-2 mb-4">Parameters</h4>
                <div className="text-sm text-white/60 mb-2"><code className="text-white bg-white/4 px-1.5 py-0.5 rounded">q</code> (string) - Required query</div>
                <div className="text-sm text-white/60 mb-2"><code className="text-white bg-white/4 px-1.5 py-0.5 rounded">limit</code> (int) - Default 5</div>
              </div>
