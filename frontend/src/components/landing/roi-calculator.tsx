      ...
      <div className="mx-auto max-w-[1000px] px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="bg-[#0C0C0C] border border-white/10 rounded-3xl p-8 lg:p-10 shadow-2xl relative group hover:border-white/20 transition-all duration-500">
            <Calculator className="absolute top-8 right-8 size-8 text-white/5 group-hover:text-purple-400/20 transition-colors duration-500" />
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-linear-to-br from-emerald-500/10 to-emerald-500/5 border border-emerald-500/20 rounded-3xl p-8 relative overflow-hidden group hover:border-emerald-500/40 transition-colors duration-500">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white/[0.03] border border-white/10 rounded-3xl p-6 group hover:bg-white/[0.05] transition-colors duration-500">
                <TrendingDown className="size-4 text-purple-400 mb-3" />
