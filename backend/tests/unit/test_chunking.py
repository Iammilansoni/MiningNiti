...
def pages_for_simple_text():
    ...
    third = text_len // 3
    return [
        PageContent(page_number=1, text=SIMPLE_TEXT[:third], char_start=0, char_end=third),
        PageContent(page_number=2, text=SIMPLE_TEXT[third:2*third], char_start=third, char_end=2*third),
        PageContent(page_number=3, text=SIMPLE_TEXT[2*third:], char_start=2*third, char_end=text_len),
    ]
...
class TestChunkingBasic:
    ...
    def test_single_short_sentence(self, chunker):
        ...
        pages = [PageContent(page_number=1, text=text, char_start=0, char_end=len(text))]
...
class TestPageNumberTracking:
    ...
    def test_single_page_document(self, chunker):
        ...
        pages = [PageContent(
            page_number=1, text=SIMPLE_TEXT,
...
class TestChunkOverlap:
    ...
    def test_overlap_words_appear_in_adjacent_chunks(self):
        ...
        pages = [PageContent(page_number=1, text=long_text, char_start=0, char_end=len(long_text))]
...
class TestChunkingEdgeCases:
    ...
    def test_very_long_single_sentence(self, chunker):
        ...
        pages = [PageContent(page_number=1, text=long_sentence, char_start=0, char_end=len(long_sentence))]
